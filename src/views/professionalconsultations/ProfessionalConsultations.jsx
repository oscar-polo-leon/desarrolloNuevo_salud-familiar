...
function ProfessionalConsultations() {
  ...
  return (
    ...
    <Breadcrumb style={{ margin: '16px 0', }} >
      ...
      <Breadcrumb.Item>Consultas profecionales</Breadcrumb.Item>
    </Breadcrumb>
    <div className='container__principal'>
      <Form name="basic" labelCol={{ span: 18, }} wrapperCol={{ sm: 24, md: 24, lg: 8 }} layout="vertical" onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete="off" >
        <Form.Item label="Tipo de consulta" name="conditionType" rules={[ { required: true, message: 'Campo requerido.', }, ]}>
        ...
        <Form.Item label="Nombre del profecional" name="conditionType" rules={[ { required: true, message: 'Campo requerido.', }, ]}>
        <Input placeholder='Nombre un nombre' />
        </Form.Item>
